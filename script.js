...
function makeArticle(data, index)
{
  ...
  aFigure.style.backgroundImage = data.img;
  ...
  aButton.classList.add('accordion');
  aButton.setAttribute("data-index", index);
  aButton.setAttribute("keyword", "hello");
...
const data = [
  ...
  {
    img : 'url("http://img.sbs.co.kr/newimg/news/20201008/201478269_700.jpg")',
    title : '유기동물에 대한 \n 슬픈 보고서',
    pica : '유기동물',
    keyword : '유기동물',
    p : '지난 2년 간 전국 226개 기초의회에서 쓴 업무추진비를 탈탈 털어봤다. 정보공개청구부터 보도까지 2개월에 걸친 끈질긴 추적은 결국 잘못 쓴 업무추진비 반환까지 이끌어냈다. 데이터저널리즘 기법을 활용한 탐사보도는 과연 뭐가 달랐을까?',
  ...
  {
    img : 'url("http://img.sbs.co.kr/newimg/news/20200417/201422571_700.jpg")',
  ...
  {
    img : 'url("http://img.sbs.co.kr/newimg/news/20200220/201404584_700.jpg")',
    title : '2020 총선 \n 예비후보자 전수 분석',
    pica : '#국회',
    keyword : '국회',
    p : '코로나19가 심상치 않다? 마부작침은 확진 초기부터 발 빠르게 확진자 현황 데이터를 수집해서 확진 경로 네트워크(network)를 비롯해 현황판, 통계 분석 등 다양한 데이터 분석 보도를 진행했다.',
  ...
  {
    img : 'url("http://img.sbs.co.kr/newimg/news/20200203/201398503_700.jpg")',
    title : '의원님의 \n 수상한 예산심사는 \n 계속됩니다',
    pica : '#예산 #국회 #회의록',
    keyword : '예산',
    keyword2 : '국회',
  ...
  {
    img : 'url("http://img.sbs.co.kr/newimg/news/20200102/201389213_700.jpg")',
    title : '그들은 왜 윤창호법을 \n 두려워하지 않을까',
    pica : '#교통안전 #판결문',
    keyword : '교통안전',
    keyword2 : '판결문',
